...
const correlate = require('@servicebus/correlate')
const messageDomain = require('@servicebus/message-domain')
const logger = require('@servicebus/logger')
const packageMiddleware = require('@servicebus/package')
...
class Bus extends EventEmitter {
  ...
  use (middleware) {
    if (middleware.handleIncoming)
      this.incomingMiddleware.push(middleware.handleIncoming)
    if (middleware.handleOutgoing)
      this.outgoingMiddleware.push(middleware.handleOutgoing)
    return this
  }
